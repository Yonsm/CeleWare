...
//
#define SMSComposer					CeleSMSComposer
#define MailComposer				CeleMailComposer
#define WeiboComposer				CeleWeiboComposer
#define FacebookComposer			CeleFacebookComposer
#define composeSMS					celeComposeSMS
#define composeMail					celeComposeMail
